...
export const Intro = () => {
  return (
    <div className="flex flex-col items-center border border-[#3d3d3d] w-full md:w-[350px] min-h-auto md:min-h-screen mb-4 md:mb-0 py-6 bg-eerie-black rounded-xl md:rounded-3xl md:sticky md:top-4">
      <Profile />
      <div className='w-[85%] lg:w-[213px] mt-6'>
        {/* Divider */}
        <div className='bg-[#3f3f40] w-full h-px mb-6'></div>
        ...
        <div className='w-full'>
          ...
          {/* RESUME Info - Hidden on mobile, visible on lg screens */}
          <div className="hidden lg:block">
            ...
            {/* LOCATION Info - Hidden on mobile, visible on lg screens */}
